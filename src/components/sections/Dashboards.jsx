      ...
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10 max-w-7xl mx-auto px-6">
        <div className="space-y-12 py-8">
          <div>
            <FadeIn>
              ...
              <h2 className="text-5xl lg:text-7xl font-black text-slate-900 dark:text-white mb-8 tracking-tighter leading-[0.9] transition-colors">
                Strategic
                <br />
          ...
          <div className="inline-flex p-1.5 bg-slate-100 dark:bg-white/5 rounded-[1.5rem] border border-slate-200 dark:border-white/10 backdrop-blur-2xl shadow-inner">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`relative px-8 py-3 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all duration-500 overflow-hidden ${
                  activeTab === tab.id
                    ? "bg-white dark:bg-slate-800 text-indigo-600 dark:text-white shadow-2xl scale-[1.05]"
        ...
        <div className="relative group perspective-1000">
          ...
          >
            ...
            {/* The Glass OS Frame */}
            <div className="relative w-full aspect-[4/3] bg-white/90 dark:bg-[#070b14]/90 backdrop-blur-[40px] rounded-[3rem] border border-white/60 dark:border-white/10 shadow-[0_60px_100px_-30px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col ring-1 ring-black/5 dark:ring-white/5">
              {/* Luxury Toolbar */}
              <div className="px-10 py-6 border-b border-slate-200/50 dark:border-white/5 flex items-center justify-between bg-white/50 dark:bg-white/5">
                <div className="flex items-center gap-4">
                  <div className="flex gap-2">
                    <div className="w-3 h-3 rounded-full bg-rose-500/40 border border-rose-500/20 shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)]"></div>
                    <div className="w-3 h-3 rounded-full bg-amber-500/40 border border-amber-500/20 shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)]"></div>
                    <div className="w-3 h-3 rounded-full bg-emerald-500/40 border border-emerald-500/20 shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)]"></div>
                  </div>
                  <div className="h-4 w-px bg-slate-200 dark:bg-white/10 mx-2"></div>
                  <span className="text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.4em]">
              ...
              <div className="flex-grow p-10 overflow-hidden relative">
                {activeTab === "management" && (
                  <div className="h-full flex flex-col gap-10">
                    ...
                    {/* Visualizer Wave */}
                    <div className="flex-grow bg-[#0c121e] dark:bg-black/20 rounded-[2.5rem] p-8 flex flex-col relative overflow-hidden ring-1 ring-white/5">
                  ...
                  <div className="h-full flex flex-col gap-8">
                    <div className="flex justify-between items-end mb-4">
                      ...
                      <div className="w-16 h-16 rounded-[1.5rem] bg-gradient-to-br from-indigo-500 via-violet-600 to-rose-500 p-[1px] shadow-2xl">
                        <div className="w-full h-full bg-[#070b14] rounded-[1.5rem] flex items-center justify-center text-white text-xl font-black">
                          A+
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="h-full flex flex-col gap-2">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        ...
                        <div className="absolute inset-[4px] rounded-full bg-[#070b14] flex items-center justify-center text-white text-3xl font-black border border-white/10 ring-4 ring-indigo-500/20 shadow-2xl">
                          S
                        </div>
